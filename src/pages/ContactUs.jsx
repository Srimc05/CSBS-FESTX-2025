...
const ContactUs = () => {
  return (
    <>
      <Helmet>
        <title>Contact Us | FESTX'25</title>
        <meta
          name="description"
          content="Get in touch with the FESTX'25 organizing team. Find contact details for association members and student coordinators."
        />
      </Helmet>
      <div
