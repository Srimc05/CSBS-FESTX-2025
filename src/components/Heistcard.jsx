...
export function CanvasRevealEfctDemo3() {
  const [hovered, setHovered] = React.useState(false);
  return (
    <div
      onMouseEnter={() => setHovered(true)}
      onMouseLeave={() => setHovered(false)}
      className="h-[30rem] flex flex-col lg:flex-row overflow-hidden items-center justify-center bg-black w-full gap-4 mx-auto px-8 relative border border-gray-500 rounded-lg">
      <p
        className="md:text-2xl text-2xl font-medium font-[poppins] leading-10 text-center text-white relative z-20 max-w-2xl mx-auto">
            <h1 className="text-red-500">Tokyo Protocol</h1>
        Execute rapid decoding challenges secret chits to infiltrate and loot up to a certain percentage of the score from rival crew vaults!
