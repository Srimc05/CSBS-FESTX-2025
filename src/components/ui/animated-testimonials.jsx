...
const AnimatedTestimonials = ({ testimonials, autoplay = false }) => {
 ...
 const handleNext = useCallback(() => {
  ...
  var hello=motion.address;//dummy rto avoid eslint errror 
  hello.animate;
...
useEffect(() => {
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12 lg:pt-0">
